...
func init() {
	...
	buildArgument.Flags().StringP("teamserver", "t", "", "Set teamserver URL")
	buildArgument.Flags().StringP("worker", "w", "", "Set worker URL")
	buildArgument.Flags().StringP("name", "n", "", "Set worker name")
	buildArgument.Flags().StringP("port", "p", "8443", "Set port for the teamserver")
